...
namespace ChatSharp
{
    ...
    [System.Security.Permissions.SecurityPermission(System.Security.Permissions.SecurityAction.Demand)]
        ...
        public delegate void ConnectionFailedEventHandler(object sender, ConnectionFailedEventArgs Args);
        ...
        private void ConnectComplete(IAsyncResult result)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    ConnectionFailedEvent(this, new ConnectionFailedEventArgs(ex));
                    return;
                }
                else
                {
                    throw new Exception("Conection to Server failed", ex);
                }
            }
